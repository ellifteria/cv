...
\small{\item{Software engineering research for scientific programming; reproducibility, replicability, and reuse in computational science; computing education for disciplinary scientists \\ \vspace{3pt}}}
...
{PhD in Computer Science \& Engineering (in progress)}{Sep 2024 – Present}
...
{\begin{minipage}{0.6\columnwidth}Programming Languages and Software Engineering (PLSE) Group \\ and Learning, Computing, Imagination (LCI) Lab\end{minipage}}{\begin{minipage}{0.3\columnwidth}Paul G. Allen School of Computer Science \& Engineering\end{minipage}}
...
\resumeItemListStart
\resumeItem{Designed platform for simulating rigid-body virtual robots with the ability to physically grow as they interact with their simulated environment.}
\resumeItemListEnd
...
\resumeItemListStart
\resumeItem{Designed and implemented Python package for easy-to-use, rapid, batch flow cytometry data analysis for synthetic biologists.}
\resumeItemListEnd
...
\textbf{Beres E}, et al. PyFlowBAT: An Open-Source Software Package for Performing High-Throughput Batch Analysis of Flow Cytometry Data. Poster presented at: EBRC Annual Meeting; 2023 Jun 5-6; Evanston, IL.
\end{minipage} \\
